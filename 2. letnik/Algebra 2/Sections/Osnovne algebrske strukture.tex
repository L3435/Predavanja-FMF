...
\begin{definicija}
\emph{Simetrična grupa}\index{Grupa!Simetrična}
...
\emph{Alternirajoča grupa}\index{Grupa!Alternirajoča} je grupa
...
\emph{direktni produkt}\index{Algebrska struktura!Grupa!Direktni produkt}
grup $G_1, \dots, G_m$.
\end{definicija}
...
\]
z operacijami po komponentah pravimo
\emph{direktni produkt}\index{Algebrska struktura!Kolobar!Direktni produkt}\footnote{
...
\]
z operacijami po komponentah pravimo
\emph{direktna vsota}\index{Algebrska struktura!Vektorski prostor!Direktna vsota}
...
\]
z operacijami po komponentah pravimo
\emph{direktni produkt}\index{Algebrska struktura!Algebra!Direktni produkt}

...
\emph{integrabilna}\index{Integral}, če velja
\[
I_D = s = S.
\]
Označimo
\[
I_D = \int_K f(x)\;dx = \int_K f(x)\;dV(x) =
\idotsint\limits_K f(x_1,\dots,x_n)\;dx_n\dots dx_1.
\]
\end{definicija}
...
\]
\emph{Riemannova vsota}\index{Riemannova vsota} je
\[
